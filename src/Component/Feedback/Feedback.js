      ...
      <img src={star} alt='star-image' className={styles.star}/>
        ...
        <Row className='align-items-center d-flex mt-5 mb-5'>
            <Col md={12}className="d-flex justify-content-center">
                ...
                "Trust is at the core of Stylrax. Our thorough verification process<br/> ensures
                 a safe and secure environment for both professionals<br/> and clients. Build your
                  reputation and trust with our trusted<br/> community."
                </p>
                </div>
            </Col>
            </Row>
