...
import styles from "../../assets/scss/pages/home/Banner4.module.css";
const Banner4 = () => {
  return (
   <main className={styles.main}>
    ...
    Stylrax, the Ultimate platform for <br/>freelancers and Salon owners to showcase <br/>their 
    skills and connect with clients.<br/> Empower your business with our innovative <br/>solutions.
    
    </p>
    </Col>
    <img src={client1} alt='client-img' className={styles.clientOne}/>
    <img src={client3} alt='client-img'  className={styles.clientThree}/>
    </div>
    </Row>
    </Container>
   </main>
