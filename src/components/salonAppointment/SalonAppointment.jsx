...
import { appointments, assign } from "./apointmentData";
...
import OngoingApp from "../ongoing/OngoingApp";
  ...
  return (
    <main>
      <Container>
        ...
        {activeButton === "button1" && <div><OngoingApp/></div>}
                    ...
                    <div className={styles.userInfo}>
                      ...
                      <Col md={4}>
                        <p className={styles.user}>
                         ...
                         <span styles={styles.locationDistance}><GrFormLocation className={styles.location}/>1.5km</span>
                        </p>
